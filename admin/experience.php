...
<div class="container">
                  <button type="button" class="btn m-2 btn-success" id="myBtn" data-toggle="modal" data-target="#myModal1" data-show="true">Add Experience</button>
                  </div>
                ...
                <center>
                  ...
                  $link="contents/update_experience.php?id=".urlencode(base64_encode($data));
...
del.onclick = function() {
  location.href ='contents/delete_experience.php?id=<?php echo $row['id']; ?>';
}
